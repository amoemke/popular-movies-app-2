...
public class TestFavoritesDatabase {

    /* Context used to perform operations on the database and create FavoritesDbHelper */
    ...
    public void create_database_test() throws Exception{
        ...
        /* Use FavoritesDbHelper to get access to a writable database */
        ...
        assertEquals("Error: Your database was created without the expected tables.",
                FavoritesContract.FavoritesEntry.TABLE_NAME, tableNameCursor.getString(0));
    ...
    public void insert_single_record_test() throws Exception{
        ...
        testValues.put(FavoritesContract.FavoritesEntry.COLUMN_NAME_MOVIE_ID, 12345);
        testValues.put(FavoritesContract.FavoritesEntry.COLUMN_NAME_ORIGINAL_TITLE, "test title");
    ...
    void deleteTheDatabase(){
        try {
            ...
            fail("Make sure you have a member called DATABASE_NAME in the FavoritesDbHelper");
        }catch (Exception ex){
            fail(ex.getMessage());
        }
